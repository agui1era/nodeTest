...
module.exports = (app) => {
    app.get("/planificacion", oauth.introspect, async (req, res) => {
    ...
    /*app.post("/planificacion", oauth.introspect, async (req, res) => {
    ...
    app.put("/planificacion", oauth.introspect, async (req, res) => {
        if (await validate(req, res, "administrador")) {
            try {
    ...
    app.delete("/planificacion/:id", oauth.introspect, async (req, res) => {
        if (await validate(req, res, "administrador")) {
            try {
