...
const entityPersistence = require("./processPersistence")
...
module.exports = (app) => {
    app.get("/process", oauth.introspect, async (req, res) => {
    ...
    app.post("/process", oauth.introspect, async (req, res) => {
        if (await validate(req, res, "administrador")) {
            try {
                ...
                let createdEntity = await entityPersistence.create(entity,req.query.idplanta)
    ...
    app.put("/process", oauth.introspect, async (req, res) => {
        if (await validate(req, res, "administrador")) {
            try {
    ...
    app.delete("/process/:id", oauth.introspect, async (req, res) => {
        if (await validate(req, res, "administrador")) {
            try {
