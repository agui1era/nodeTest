...
module.exports = (app) => {
    app.get("/iniciadorot", oauth.introspect, async (req, res) => {
    ...
    app.post("/iniciadorot", oauth.introspect, async (req, res) => {
    ...
    app.put("/iniciadorot", oauth.introspect, async (req, res) => {
        if (await validate(req, res, "administrador")) {
            try {
    ...
    app.delete("/iniciadorot/:id", oauth.introspect, async (req, res) => {
        if (await validate(req, res, "administrador")) {
            try {
