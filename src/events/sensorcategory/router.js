...
module.exports = (app) => {
    app.get("/categoriasensor", oauth.introspect, async (req, res) => {
    ...
    app.post("/categoriasensor", oauth.introspect, async (req, res) => {
    ...
    app.put("/categoriasensor", oauth.introspect, async (req, res) => {
        if (await validate(req, res, "administrador")) {
            try {
    ...
    app.delete("/categoriasensor/:id", oauth.introspect, async (req, res) => {
        if (await validate(req, res, "administrador")) {
            try {
