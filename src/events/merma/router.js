...
module.exports = (app) => {
    app.get("/mermas", oauth.introspect, async (req, res) => {
    ...
    app.post("/mermas", oauth.introspect, async (req, res) => {
    ...
    app.put("/mermas", oauth.introspect, async (req, res) => {
        if (await validate(req, res, "administrador")) {
            try {
    ...
    app.delete("/mermas/:id", oauth.introspect, async (req, res) => {
        if (await validate(req, res, "administrador")) {
            try {
